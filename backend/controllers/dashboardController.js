...
exports.getDashboardData = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Server Error abc", error });
  }
};
...
//     // ✅ Match userId as string (not ObjectId)
//     const totalIncome = await Income.aggregate([
//       { $match: { userId: userId } },
//       { $group: { _id: null, total: { $sum: "$amount" } } },
//     ]);
...
//     // ✅ Last 5 transactions from both Income & Expense
//     const lastTransactions = [
